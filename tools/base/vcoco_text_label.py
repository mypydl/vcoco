vcoco_hoi_text_label = {
    ...
    (0, 53): 'a photo of a person holding a pizza', 
    (2, 80): 'a photo of a person sitting on',
    (8, 53): 'a photo of a person eating a pizza',
    (9, 80): 'a photo of a person eating with something',
    (23, 80): 'a photo of a person smiling', 
    (21, 37): 'a photo of a person surfing with a surfboard',
    (0, 73): 'a photo of a person holding a book',
    (2, 13): 'a photo of a person sitting on a bench',
    (5, 73): 'a photo of a person looking at a book',
    (27, 73): 'a photo of a person reading a book', 
    (1, 80): 'a photo of a person standing',
    (22, 36): 'a photo of a person skateboarding with a skateboard',
    (20, 30): 'a photo of a person skiing with a skis', 
    (0, 80): 'a photo of a person holding',
    (8, 80): 'a photo of a person eating', 
    (2, 56): 'a photo of a person sitting on a chair',
    (5, 63): 'a photo of a person looking at a laptop',
    (19, 63): 'a photo of a person working on a laptop',
    (0, 40): 'a photo of a person holding a wine glass',
    (24, 40): 'a photo of a person drinking with a wine glass',
    (5, 31): 'a photo of a person looking at a snowboard',
    (28, 31): 'a photo of a person snowboarding with a snowboard',
    ...
    (2, 17): 'a photo of a person sitting on a horse',
    (3, 17): 'a photo of a person riding a horse', 
    (4, 80): 'a photo of a person walking',
    (5, 29): 'a photo of a person looking at a frisbee', 
    (10, 80): 'a photo of a person jumping',
    (14, 29): 'a photo of a person throwing a frisbee', 
    (18, 80): 'a photo of a person running',
    ...
    (13, 24): 'a photo of a person carrying a backpack', 
    (11, 80): 'a photo of a person laying',
    (11, 57): 'a photo of a person laying on a couch',
    (0, 17): 'a photo of a person holding a horse', 
    (0, 15): 'a photo of a person holding a cat',
    (11, 59): 'a photo of a person laying on a bed',
    (15, 29): 'a photo of a person catching a frisbee', 
    (3, 80): 'a photo of a person riding',
    (12, 67): 'a photo of a person talking on a cell phone',
    (0, 31): 'a photo of a person holding a snowboard',
    (10, 31): 'a photo of a person jumping on a snowboard',
    (5, 36): 'a photo of a person looking at a skateboard',
    (10, 36): 'a photo of a person jumping on a skateboard',
    (0, 79): 'a photo of a person holding a toothbrush', 
    (27, 80): 'a photo of a person reading',
    (0, 39): 'a photo of a person holding a bottle',
    (24, 39): 'a photo of a person drinking with a bottle',
    (2, 59): 'a photo of a person sitting on a bed',
    ...
    (2, 3): 'a photo of a person sitting on a motorcycle',
    ...
    (17, 55): 'a photo of a person cutting a cake', 
    (7, 80): 'a photo of a person hitting',
    (0, 34): 'a photo of a person holding a baseball bat',
    (6, 34): 'a photo of a person hitting with a baseball bat',
    (15, 80): 'a photo of a person catching', 
    (2, 57): 'a photo of a person sitting on a couch',
    ...
    (2, 20): 'a photo of a person sitting on an elephant',
    ...
    (24, 41): 'a photo of a person drinking with a cup', 
    (14, 80): 'a photo of a person throwing',
    ...
    (0, 26): 'a photo of a person holding a handbag', 
    (13, 80): 'a photo of a person carrying',
    ...
    (2, 1): 'a photo of a person sitting on a bicycle',
    (3, 1): 'a photo of a person riding a bicycle',
    (5, 1): 'a photo of a person looking at a bicycle', 
    (25, 80): 'a photo of a person kicking',
    ...
    (10, 37): 'a photo of a person jumping on a surfboard',
    ...
    (0, 20): 'a photo of a person holding an elephant', 
    (21, 80): 'a photo of a person surfing',
    ...
    (11, 56): 'a photo of a person laying on a chair',
    ...
    (8, 46): 'a photo of a person eating a banana', 
    (20, 80): 'a photo of a person skiing',
    (28, 80): 'a photo of a person snowboarding', 
    (0, 14): 'a photo of a person holding a bird',
    (11, 60): 'a photo of a person laying on a dining table',
    ...
    (2, 61): 'a photo of a person sitting on a toilet', 
    (24, 80): 'a photo of a person drinking',
    ...
    (11, 13): 'a photo of a person laying on a bench',
    ...
    (5, 5): 'a photo of a person looking at a bus', 
    (3, 2): 'a photo of a person riding a car',
    (10, 30): 'a photo of a person jumping on a skis',
    (5, 4): 'a photo of a person looking at an airplane',
    (5, 46): 'a photo of a person looking at a banana',
    (2, 28): 'a photo of a person sitting on a suitcase',
    ...
    (24, 45): 'a photo of a person drinking with a bowl',
    ...
    (2, 24): 'a photo of a person sitting on a backpack',
    ...
    (0, 8): 'a photo of a person holding a boat', 
    (17, 45): 'a photo of a person cutting a bowl',
    ...
    (2, 26): 'a photo of a person sitting on a handbag',
    (26, 52): 'a photo of a person pointing a hot dog',
    (2, 60): 'a photo of a person sitting on a dining table',
    ...
    (5, 2): 'a photo of a person looking at a car', 
    (3, 5): 'a photo of a person riding a bus',
...
vcoco_obj_text_label = [  # 和 HICO-Det 一样
    ...
    (80, 'a photo of nothing')  # 唯独多了这个异类
]
